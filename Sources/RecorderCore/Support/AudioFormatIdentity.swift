...
extension AudioStreamBasicDescription {
    ...
    /// planar Float32) is just as incompatible as a rate change. Shared by `MovieRecorder`'s
    /// fail-stop and `ReplayAudioRing`'s re-latch so the two can't disagree on "switched".
